    ...
    <div class="container-fluid">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover">
				<form action="${pageContext.request.contextPath }/articleInsert" method="post" id="editerFrm" enctype="multipart/form-data">
					...
					<tr>
						<td> 파일첨부 1 </td>
						<td> <input type="file" name="attach_file_name" size = "50"> </td>
					</tr>
					<tr>
						<td> 파일첨부 2 </td>
						<td> <input type="file" name="attach_file_name" size = "50"> </td>
