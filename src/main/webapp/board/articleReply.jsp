    ...
    <div class="container-fluid">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover">
				<form action="${pageContext.request.contextPath }/articleReply" method="post" id="editerFrm" enctype="multipart/form-data">
					<input type="hidden" name="article_num" size = "50" value="${articleVO.article_num }">
					<input type="hidden" name="article_group_num" size = "50" value="${articleVO.article_group_num }">
					...
					<tr>
						<td> 내용 글번호${articleVO.article_num } 게시판번호${articleVO.board_num } </td>
						<td><textarea name="smarteditor" id="smarteditor" rows="10" cols="100" style="width:766px; height:412px;">
							
						</textarea></td>
					</tr>
					<tr>
						<td colspan="2">
							<input type="button" id="savebutton" value="입력" />&nbsp;&nbsp; 
